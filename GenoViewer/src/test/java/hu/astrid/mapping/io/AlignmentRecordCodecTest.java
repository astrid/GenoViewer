 ...
 * @author user
 */
public class AlignmentRecordCodecTest {

	public AlignmentRecordCodecTest() {
	}
	...
	public void testParseAlignmentRecordByteArrayListOfString() throws Exception {
		...
		AlignmentPosition actual = new AlignmentRecordCodec(Arrays.asList("Generated genom")).decodePosition(byteArray);

		assertEquals("1938 Generated genom FW - secondary genom 901\t" +
				"Generated genom\t" +
				"906\t49",
				actual.toString());
	}
